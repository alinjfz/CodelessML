...
import { DASHBOARD_URL, PROFILE_URL } from "../constants/routes";
...
function ChangePassForm({
  ...
  const changePass = async function changePassFunc() {
    if (typeof onChangePass === "function") {
      const x = {
        current_password: formData.current_password,
        new_password: formData.new_password,
      };
      await onChangePass(x);
    }
  };
    ...
    <>
      ...
      <form>
        <div className="form-floating mb-3">
          ...
          <label htmlFor="floatingPass">Current Password</label>
        </div>
        <div className="form-floating mb-3">
          <input
            type="password"
        ...
        <div className="d-grid">
          ...
          <Row>
            <Col>
              <Link to={PROFILE_URL} className="float-left">
...
const mapDispatchToProps = (dispatch) => {
  return {
    onChangePass: (data) => AuthApi.api_change_pass(data)(dispatch, {}),
